            ...
            <form method="POST">
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <select name="tipo_doc" id="edit_tipo" class="form-control col-3"><option value="V">V-</option><option value="J">J-</option><option value="E">E-</option><option value="G">G-</option></select>
