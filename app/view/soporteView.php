...
<body class="flex flex-col min-h-screen">
  ...
  <header class="fixed top-0 w-full px-10 py-5 flex justify-between items-center z-50 bg-[rgba(8,8,44,0.95)] shadow-xl">
    ...
    <nav class="flex items-center gap-6 text-sm uppercase tracking-widest">
      <a href="menuView.php" class="text-white hover:text-gray-300 transition-colors flex items-center gap-2">
  ...
  <footer class="bg-[rgb(8,8,44)] text-gray-500 py-10 px-10 text-center mt-auto">
    <p class="text-[10px] tracking-[0.2em] uppercase mb-4">&copy; 2026 Ruta Larga Furgones Unidos Carrizal. Todos los
      ...
      try {
        ...
        if (response.ok) {
          Swal.fire({
            ...
            text: 'Tu consulta ha sido recibida. Serás redirigido al login.',
            icon: 'success',
