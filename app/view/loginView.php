...
// 2. Lógica de rutas y carga del Controller
require_once dirname(__DIR__) . "/controller/LoginController.php";

$controller = new LoginController();
$mensaje = null;

$bloqueo = new LoginBloqueo($controller);
...
<body class="bg-gray-50 flex flex-col min-h-screen">
    ...
    <header
        class="fixed top-0 w-full px-10 py-5 flex justify-between items-center z-50 bg-[rgba(8,8,44,0.9)] shadow-lg">
        ...
        <nav class="hidden md:flex gap-8 text-sm uppercase tracking-widest">
            <a href="soporteView.php" class="text-white hover:text-gray-300 transition-colors">Soporte</a>
        </nav>
    </header>
    ...
    <main class="flex-grow flex items-center justify-center px-4 pt-32 pb-12">
        <div class="bg-white w-full max-w-md p-10 rounded-2xl shadow-2xl border border-gray-100">
            ...
            <?php if ($mensaje): ?>
                <div
                    class="mb-6 p-4 border-l-4 shadow-sm rounded flex items-center animate-pulse
            ...
            <?php if (!$bloqueado): ?>
                <form action="" method="post" class="space-y-5">
                    <div>
                        <label class="block text-xs font-bold text-gray-600 mb-2 uppercase tracking-widest">Correo
                            Electrónico</label>
                    ...
                    <div>
                        <label
                            class="block text-xs font-bold text-gray-600 mb-2 uppercase tracking-widest">Contraseña</label>
            ...
            <?php else: ?>
                <div class="text-center p-6 bg-gray-50 rounded-xl border border-dashed border-gray-300">
                    ...
                    <button onclick="location.reload()"
                        class="mt-4 text-xs text-blue-500 font-bold uppercase tracking-widest hover:underline">
